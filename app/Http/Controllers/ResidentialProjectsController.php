...
class ResidentialProjectsController extends Controller
{
    public function index()
    {
        return response()->json(ResidentialProject::all());
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'route' => 'required|string|unique:residential_projects',
        ...
        $project = ResidentialProject::create($validated);

        return response()->json([
            'message' => 'Residential project created successfully.',
            'data' => $project
        ], 201);
    }
